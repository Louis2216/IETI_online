...
<head>
    ...
    <script>
        ...
        function deleteImage(button) {
            ...
            var imageId = card.getAttribute('data-id');  // Get the image ID from data-id attribute

            var xhr = new XMLHttpRequest();
            xhr.open("POST", "admindeleteimage2.php", true);
            ...
            xhr.onload = function() {
                ...
                console.log(xhr.responseText);  // Debugging output to console
            };
            xhr.send("id=" + encodeURIComponent(imageId));  // Send the image ID in the POST request
        }
...
<body>
            ...
            <div class="nav-links" id="navLinks">
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-content">
                            <li><a href="adminregs.html">Inquiry</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
  ...
  <div class="column">
    <div class="image-container">
      <p>UNIFORM</p>
      <?php display_course_images('UNIFORMS'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="UNIFORMS" />
  ...
  <div class="column">
    <div class="image-container">
      <p>BSIT UNIFORM</p>
      <?php display_course_images('BSIT'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="BSIT" />
        <button type="submit">Add Image</button>
      </form>
    </div>
  </div>
...
<div class="row">
  <div class="column">
    <div class="image-container">
      <p>BSCPE UNIFORM</p>
      <?php display_course_images('BSCPE'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="BSCPE" />
        <button type="submit">Add Image</button>
      </form>
    </div>
  </div>
...
<div class="row">
  <div class="column">
    <div class="image-container">
      <p>BSHRM UNIFORM</p>
      <?php display_course_images('BSHRM'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="BSHRM" />
        <button type="submit">Add Image</button>
      </form>
    </div>
  </div>
...
<div class="row">
  <div class="column">
    <div class="image-container">
      <p>BSBA UNIFORM</p>
      <?php display_course_images('BSBA'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="BSBA" />
        <button type="submit">Add Image</button>
      </form>
    </div>
  </div>
...
<div class="row">
  <div class="column">
    <div class="image-container">
      <p>BEED UNIFORM</p>
      <?php display_course_images('BEED'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="BEED" />
        <button type="submit">Add Image</button>
      </form>
    </div>
  </div>
...
<div class="row">
  <div class="column">
    <div class="image-container">
      <p>SIZES</p>
      <?php display_course_images('SIZES'); ?>
      <form action="adminuploadimage2.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="image" required />
        <input type="text" name="title" placeholder="Image Title (Optional)" />
        <input type="hidden" name="category" value="SIZES" />
        <button type="submit">Add Image</button>
      </form>
    </div>
  </div>
    ...
    <?php
    function display_course_images($category) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<img src='data:image/jpeg;base64," . $row['image_data'] . "' alt='" . $row['title'] . "' onclick='openModal(this);' class='course-image' />";
                if (!empty($row['title'])) {
                    echo "<h3>" . htmlspecialchars($row['title']) . "</h3>";
                }
                echo "<button class='delete-btn' onclick='deleteImage(this)'>Delete</button>";
                echo "</div>";
            }
