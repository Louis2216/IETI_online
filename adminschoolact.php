...
<script>
  function deleteImage(button) {
            ...
            xhr.open("POST", "admindeleteimage.php", true);
...
$sections = [];
$sql = "SELECT identifier, paragraph_content FROM content_table WHERE identifier IN ('section1', 'section2', 'section3', 'section4', 'section5')";
...
<p class="editable-content"><?php echo htmlspecialchars($sections['section1'] ?? ''); ?></p>
    <form method="post" action="">
    <label for="section1">Edit Event Section 1:</label>
    <input type="text" id="section1" name="section1" value="<?php echo htmlspecialchars($sections['section1'] ?? ''); ?>" placeholder="Enter text here...">
    <input type="submit" value="Update Section 1">
</form>
    <?php display_images('E-SPORT EVENTS'); ?>
    
    <form action="adminuploadimage.php" method="POST" enctype="multipart/form-data">
        <div class="row1">
            <div class="Sports"> <!-- Changed "sports" to "Sports" -->
                <div class="card">
                    ...
                    <input type="hidden" name="category" value="E-SPORT EVENTS" />
...
<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section2'] ?? ''); ?></p>
<form method="post" action="">
    <label for="section2">Edit Event Section 2:</label>
    <input type="text" id="section2" name="section2" value="<?php echo htmlspecialchars($sections['section2'] ?? ''); ?>" placeholder="Enter text here...">
    <input type="submit" value="Update Section 2">
</form>
    <?php display_images('PHYSICAL SPORT EVENTS'); ?>
        ...
        <div class="row2">
            <div class="Sports">
                <div class="card">
                    <input type="file" name="image" id="newImage" />
                    <input type="text" name="title" id="newTitle" placeholder="Image Title (Optional)" />
                    <input type="hidden" name="category" value="PHYSICAL SPORT EVENTS" />
                    <button type="submit">Add Image</button>
                </div>
            </div>
        </div>
...
<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section3'] ?? ''); ?></p>
    <form method="post" action="">
    <label for="section3">Edit Event Section 3:</label>
    <input type="text" id="section3" name="section3" value="<?php echo htmlspecialchars($sections['section3'] ?? ''); ?>" placeholder="Enter text here...">
    <input type="submit" value="Update Section 3">
</form>
    <?php display_images('BUWAN NG WIKA'); ?>
        ...
        <div class="row3">
            <div class="Sports">
                <div class="card">
                    <input type="file" name="image" id="newImage" />
                    <input type="text" name="title" id="newTitle" placeholder="Image Title (Optional)" />
                    <input type="hidden" name="category" value="BUWAN NG WIKA" />
                    <button type="submit">Add Image</button>
                </div>
            </div>
        </div>
...
<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section4'] ?? ''); ?></p>
<form method="post" action="">
    <label for="section4">Edit Event Section 4:</label>
    <input type="text" id="section4" name="section4" value="<?php echo htmlspecialchars($sections['section4'] ?? ''); ?>" placeholder="Enter text here...">
    <input type="submit" value="Update Section 4">
</form>
    <?php display_images('ORIENTATION'); ?>
        ...
        <div class="row4">
            <div class="Sports">
                <div class="card">
                    <input type="file" name="image" id="newImage" />
                    <input type="text" name="title" id="newTitle" placeholder="Image Title (Optional)" />
                    <input type="hidden" name="category" value="ORIENTATION" />
                    <button type="submit">Add Image</button>
                </div>
            </div>
        </div>
...
<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section5'] ?? ''); ?></p>
<form method="post" action="">
    <label for="section5">Edit Event Section 5:</label>
    <input type="text" id="section5" name="section5" value="<?php echo htmlspecialchars($sections['section5'] ?? ''); ?>" placeholder="Enter text here...">
    <input type="submit" value="Update Section 5">
</form>
    <?php display_images('FIELDTRIP'); ?>
        ...
        <div class="row4">
            <div class="Sports">
                <div class="card">
                    <input type="file" name="image" id="newImage" />
                    <input type="text" name="title" id="newTitle" placeholder="Image Title (Optional)" />
                    <input type="hidden" name="category" value="FIELDTRIP" />
                    <button type="submit">Add Image</button>
                </div>
            </div>
        </div>
...
function display_images($category) {
    ...
    $sql = "SELECT id, title, image_data, mime_type FROM images WHERE category = ?";
    $stmt = $conn->prepare($sql);
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<img src='data:" . $row['mime_type'] . ";base64," . $row['image_data'] . "' alt='" . $row['title'] . "' onclick='openModal(this);' />";
            if (!empty($row['title'])) {
