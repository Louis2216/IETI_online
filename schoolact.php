...
<p class="editable-content"><?php echo htmlspecialchars($sections['section1'] ?? ''); ?></p>
    <?php display_images('E-SPORT EVENTS', false); ?>  <!-- Set second argument to false for no add/delete functionality -->
</section>

<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section2'] ?? ''); ?></p>
    <?php display_images('PHYSICAL SPORT EVENTS', false); ?> <!-- Set second argument to false for no add/delete functionality -->
</section>

<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section3'] ?? ''); ?></p>
    <?php display_images('BUWAN NG WIKA', false); ?> <!-- Set second argument to false for no add/delete functionality -->
</section>

<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section4'] ?? ''); ?></p>
    <?php display_images('ORIENTATION', false); ?> <!-- Set second argument to false for no add/delete functionality -->
</section>

<section class="Activity">
<p class="editable-content"><?php echo htmlspecialchars($sections['section5'] ?? ''); ?></p>
    <?php display_images('FIELDTRIP', false); ?> <!-- Set second argument to false for no add/delete functionality -->
</section>
<?php
